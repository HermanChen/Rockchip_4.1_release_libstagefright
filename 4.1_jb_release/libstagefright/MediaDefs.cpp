...
const char *MEDIA_MIMETYPE_VIDEO_M2V =  "video/mp2";
...
const char *MEDIA_MIMETYPE_AUDIO_AC3 = "audio/x-ms-ac3";
const char *MEDIA_MIMETYPE_AUDIO_RA = "audio/vnd.rn-realaudio";
const char *MEDIA_MIMETYPE_AUDIO_DTS = "audio/vnd.dts.hd";
const char *MEDIA_MIMETYPE_AUDIO_WMA = "audio/x-ms-wma";
/* added by helun 2011-12-2 */
