...
#if ON2_AVC_ENC
     vpu_api_init(&sEncApi,OMX_ON2_VIDEO_EncodingAVC);
...
status_t AVCEncoder::read(
    ...
    *out = NULL;
	...
	//ALOGI("ImageType = %d\n", imgtype);
		...
		int ret = sEncApi.enc_oneframe_class_On2Encoder(pOn2Enc,outPtr,&dataLength,NULL,(uint32_t)busaddress,&inputLen,&outPutTime,&SyncFlag);
